...
export const quizQuestionsEs: QuizQuestion[] = [
  {
    ...
    options: [
      { text: "Desarmar algo mecánico para ver cómo funciona", points: { "mechanical-engineering": 2, "aerospace-engineering": 1, "materials-engineering": 1, "robotics-engineering": 1 }, themes: ["hands-on-building"] },
  ...
  },
  {
    ...
    options: [
      { text: "Adelante — me gusta más entre más abstracto se vuelve", points: { "electrical-engineering": 2, "software-engineering": 1, "industrial-engineering": 1, "materials-engineering": 1 }, themes: ["abstract-problem-solving"] },
      { text: "Me gusta más cuando puedo verlo en acción — fuerzas, movimiento, estructuras", points: { "mechanical-engineering": 2, "civil-engineering": 1, "aerospace-engineering": 1, "materials-engineering": 1 }, themes: ["hands-on-building"] },
  ...
  },
  {
    ...
    options: [
      { text: "Proyectos de avance lento (años) pero con un gran impacto público", points: { "civil-engineering": 2, "biomedical-engineering": 1, "aerospace-engineering": 1, "environmental-engineering": 1, "materials-engineering": 1 }, themes: ["long-term-projects", "public-impact"] },
      ...
      { text: "Proyectos de ritmo medio centrados en prototipado físico e iteración", points: { "mechanical-engineering": 2, "aerospace-engineering": 1, "robotics-engineering": 1, "materials-engineering": 1 }, themes: ["hands-on-building"] },
      { text: "Proyectos de ritmo medio con requisitos estrictos de seguridad y pruebas", points: { "biomedical-engineering": 1, "electrical-engineering": 1, "aerospace-engineering": 1, "chemical-engineering": 1, "environmental-engineering": 1 }, themes: ["regulation-safety"] },
    ],
  },
  {
    ...
    options: [
      ...
      { text: "Un sitio de construcción o trabajo de campo", points: { "civil-engineering": 2, "environmental-engineering": 1 }, themes: ["structures-infrastructure"] },
      ...
      { text: "Una mezcla genuina — a veces práctico, a veces en una computadora", points: { "electrical-engineering": 2, "mechanical-engineering": 1, "robotics-engineering": 2, "computer-engineering": 1 }, themes: ["electronics", "hands-on-building"] },
    ],
  },
  {
    id: "fun-to-build",
    ...
    options: [
      { text: "Un pequeño robot o dispositivo mecánico", points: { "mechanical-engineering": 2, "robotics-engineering": 2, "aerospace-engineering": 1 }, themes: ["hands-on-building"] },
      ...
      { text: "Un puente a escala, y probar cuánto peso aguanta antes de fallar", points: { "civil-engineering": 2, "materials-engineering": 2, "environmental-engineering": 1 }, themes: ["structures-infrastructure"] },
    ],
  },
  {
    ...
    options: [
      { text: "Un problema donde puedes ver y tocar lo que estás trabajando", points: { "mechanical-engineering": 2, "civil-engineering": 1, "aerospace-engineering": 1, "materials-engineering": 1, "robotics-engineering": 1 }, themes: ["hands-on-building"] },
      { text: "Un problema que es completamente abstracto, sin ningún componente físico", points: { "software-engineering": 2, "electrical-engineering": 1, "industrial-engineering": 2, "computer-engineering": 1 }, themes: ["abstract-problem-solving"] },
      { text: "Un problema donde la 'cosa' con la que trabajas es un sistema vivo", points: { "biomedical-engineering": 2 }, themes: ["biology-health"] },
      { text: "Un problema donde estás equilibrando códigos de seguridad en los que la mayoría de la gente nunca piensa", points: { "civil-engineering": 2, "chemical-engineering": 1, "aerospace-engineering": 1, "environmental-engineering": 1 }, themes: ["regulation-safety"] },
    ],
  },
  {
    id: "code-context",
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Construir la columna vertebral eléctrica — energía, dispositivos — de la que dependen otros sistemas", points: { "electrical-engineering": 2, "computer-engineering": 1 }, themes: ["electronics", "public-impact"] },
    ],
  },
  {
    ...
    options: [
      { text: "Está bien — entiendo por qué existe y puedo trabajar dentro de eso", points: { "civil-engineering": 1, "biomedical-engineering": 1, "aerospace-engineering": 1, "chemical-engineering": 1, "environmental-engineering": 1 }, themes: ["regulation-safety"] },
      { text: "Preferiría tener toda la libertad de diseño posible", points: { "software-engineering": 1, "mechanical-engineering": 1 }, themes: [] },
      { text: "No me molesta algo de regulación, especialmente para trabajo crítico en seguridad", points: { "electrical-engineering": 1, "biomedical-engineering": 1, "aerospace-engineering": 1, "chemical-engineering": 1 }, themes: ["regulation-safety"] },
  ...
  },
  {
    ...
    options: [
      { text: "Proyectos largos (años), con tecnología y métodos relativamente estables", points: { "civil-engineering": 2, "aerospace-engineering": 1, "materials-engineering": 1 }, themes: ["long-term-projects"] },
  ...
  },
  {
    ...
    options: [
      { text: "Proyectos que toman años e implican mucho papeleo y aprobaciones", points: { "civil-engineering": 2, "biomedical-engineering": 1, "aerospace-engineering": 1, "environmental-engineering": 1 }, themes: ["long-term-projects", "regulation-safety"] },
      ...
      { text: "Diseños que fallan en las pruebas, y necesitar paciencia para descubrir por qué", points: { "mechanical-engineering": 2, "electrical-engineering": 1, "materials-engineering": 1, "robotics-engineering": 1, "aerospace-engineering": 1 }, themes: ["debugging-troubleshooting"] },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Trabajar con un equipo amplio que incluye personas que no son ingenieras, como doctores o funcionarios de la ciudad", points: { "civil-engineering": 1, "biomedical-engineering": 1, "environmental-engineering": 1 }, themes: ["teamwork-collaboration"] },
      { text: "Trabajar de cerca con hardware y otros ingenieros para hacer que algo físico funcione", points: { "mechanical-engineering": 1, "electrical-engineering": 1, "robotics-engineering": 2, "computer-engineering": 1 }, themes: ["teamwork-collaboration", "electronics"] },
  ...
  },
  {
    ...
    options: [
      { text: "Ver un resultado físico y tangible de tu trabajo", points: { "mechanical-engineering": 2, "civil-engineering": 1, "aerospace-engineering": 1, "robotics-engineering": 1 }, themes: ["hands-on-building"] },
      ...
      { text: "Mantener funcionando sistemas públicos esenciales", points: { "civil-engineering": 2, "electrical-engineering": 1, "environmental-engineering": 2 }, themes: ["public-impact", "structures-infrastructure"] },
    ],
  },
  {
    ...
    options: [
      { text: "Si un mecanismo se está moviendo de la forma en que debería", points: { "mechanical-engineering": 2, "robotics-engineering": 1 }, themes: ["hands-on-building", "debugging-troubleshooting"] },
      { text: "Si el diseño puede sobrevivir calor, velocidad, o presión extremos", points: { "aerospace-engineering": 2 }, themes: ["hands-on-building"] },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Trabajar con algo vivo o biológico, no solo partes mecánicas", points: { "biomedical-engineering": 2 }, themes: ["biology-health"] },
  ...
  },
  {
    ...
    options: [
      { text: "Algo en lo que el público confía sin siquiera pensarlo, como agua limpia o caminos que funcionan", points: { "civil-engineering": 1, "environmental-engineering": 2 }, themes: ["public-impact"] },
      ...
      { text: "Algo construido para resistir condiciones extremas e inusuales", points: { "aerospace-engineering": 1, "materials-engineering": 1 }, themes: ["hands-on-building"] },
    ],
  },
  {
    ...
    options: [
      ...
      { text: "Regulaciones sobre el manejo seguro de materiales o químicos peligrosos", points: { "chemical-engineering": 2 }, themes: ["regulation-safety"] },
