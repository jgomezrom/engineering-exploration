    ...
    return (
      <main className="mx-auto max-w-3xl px-6 py-16 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-neutral-600 dark:text-neutral-400">
          {t.intro(stubQuizQuestions.length)}
        </p>
        <div className="mt-8">
      ...
      <main className="mx-auto max-w-2xl px-6 py-16">
        <div className="flex items-center justify-between">
          <span className="font-mono text-xs uppercase tracking-widest text-neutral-600 dark:text-neutral-400">
            {t.questionLabel} {String(currentIndex + 1).padStart(2, "0")} / {stubQuizQuestions.length}
          </span>
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-3 max-w-2xl text-neutral-600 dark:text-neutral-400">
        {t.resultsIntro(answeredCount)}
      </p>

      {results.length === 0 ? (
        <p className="mt-10 text-neutral-600 dark:text-neutral-400">{t.noneMatched}</p>
      ) : (
