...
import { meetEngineersTranslations } from "../data/translations/meetEngineers";
...
export default function MeetEngineersContent() {
  const { language } = useLanguage();
  const t = meetEngineersTranslations[language];
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <FadeIn as="section" className="mt-12">
        ...
        <div className="mt-4">
          <BulletList
            items={[t.findBullet1, t.findBullet2, t.findBullet3, t.findBullet4, t.findBullet5]}
          />
        </div>
      </FadeIn>
      ...
      <FadeIn as="section" className="mt-14 border-t border-neutral-900/10 pt-14 dark:border-white/10">
        ...
        <div className="mt-4">
          <BulletList
            items={[t.askBullet1, t.askBullet2, t.askBullet3, t.askBullet4, t.askBullet5, t.askBullet6]}
          />
        </div>
      ...
      <FadeIn as="section" className="mt-14 border-t border-neutral-900/10 pt-14 dark:border-white/10">
        ...
        <div className="mt-4">
          <BulletList items={[t.safetyBullet1, t.safetyBullet2, t.safetyBullet3, t.safetyBullet4]} />
        </div>
      </FadeIn>
