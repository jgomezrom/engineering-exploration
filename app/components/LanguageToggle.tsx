...
export default function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="flex h-9 flex-shrink-0 items-center gap-1.5 border border-neutral-900/10 px-2.5 font-mono text-xs font-medium text-neutral-600 transition-colors hover:border-primary/40 dark:border-white/10 dark:text-neutral-400"
    >
