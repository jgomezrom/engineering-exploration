...
import HeatConductionSimulator from "./HeatConductionSimulator";
...
export default function HeatConductionContent() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <FadeIn className="mt-14 border-t border-neutral-900/10 pt-14 dark:border-white/10">
        ...
        <Link href="/concepts?concept=thermodynamics" className="mt-4 inline-block text-sm font-medium text-primary hover:underline">
          {t.conceptLink}
        </Link>
      </FadeIn>
    </main>
