...
export default function ChallengeNotFound() {
  ...
  return (
    <main className="mx-auto flex max-w-xl flex-col items-center px-6 py-24 text-center">
      ...
      <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">{t.challengeHeading}</h1>
      <p className="mt-4 text-neutral-600 dark:text-neutral-400">{t.challengeBody}</p>
      <Link
        href="/challenges"
